...
| 위치 | 필요한 이미지 |
|---|---|
| README 대표 | 실시간 분석 전체 화면 캡처 |
| 실시간 분석 설명 | 영상·점수판·성공률 패널이 함께 보이는 화면 |
| 경기 전 승률 | 두 선수 카드와 구성 요인 비교 화면 |
| 샷 기록 | 여러 확정 배치 카드 |
| 선수 통계 | 선수 이미지와 세부 지표 카드 |
| 모바일 | 좁은 화면에서 세로 배치된 UI |
| 확장 프로그램 | YouTube 사이드패널 실행 화면 |

---

## 12. 관련 파일

- [`YOLO/ui/index.html`](../YOLO/ui/index.html)
- [`YOLO/extension/`](../YOLO/extension/)
